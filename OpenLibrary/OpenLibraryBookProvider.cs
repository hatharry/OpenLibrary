...
{
    public class OpenLibraryBookProvider : IRemoteMetadataProvider<Book, BookInfo>
    {
        ...
        public OpenLibraryBookProvider(IHttpClient httpClient, IJsonSerializer json, ILogger logger)
        {
